...
# discord.ext.menus is deprecated, using modern pagination
try:
    from discord.ext import menus
    MENUS_AVAILABLE = True
except ImportError:
    menus = None
    MENUS_AVAILABLE = False
...
if MENUS_AVAILABLE:
    ...
    # Fallback classes when menus is not available
    class FieldPagePaginator:
        def __init__(self, *args, **kwargs):
            raise NotImplementedError("discord.ext.menus is not available. Please use modern Discord UI views.")
